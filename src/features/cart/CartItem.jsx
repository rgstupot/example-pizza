      ...
      <div className="flex gap-3 sm:gap-4 md:gap-5">
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
          <div className="flex flex-col gap-1 sm:gap-2">
            <button onClick={() => changeQuantity(pizza.id, pizza.quantity + 1)} className="p-1.5 rounded-md hover:bg-slate-200">
        ...
        <div className="flex items-center">
          <button onClick={() => removeFromCart(pizza.id)} className="p-1.5 rounded-md hover:bg-slate-200">
